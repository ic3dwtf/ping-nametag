...
A lightweight Fabric client mod that appends live ping `(Xms)` to every player's nametag — with color-coded thresholds and full support for TextDisplay-based nametags, making it compatible with any server including mcpvp.club and stray.gg. Works with [Tier Tagger](https://modrinth.com/mod/tiertagger)!
